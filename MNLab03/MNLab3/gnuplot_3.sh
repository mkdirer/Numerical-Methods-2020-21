...
plot "out1.dat" i 0 w lp ls 1 t "x(t); {/Symbol b} = 0, F_0 = 0, {/Symbol W} = 0.8"
...
plot "out2.dat" i 0 w lp ls 1 t "x(t); {/Symbol b} = 0.4, F_0 = 0, {/Symbol W} = 0.8"

set output "x3.eps"
# Komenda rysowania trzeciej serii danych z pliku out.dat:
plot "out3.dat" i 0 w lp ls 1 t "x(t); {/Symbol b} = 0.4, F_0 = 0.1, {/Symbol W} = 0.8"
