...
set xrange [-5:5]
set grid
plot "<(sed -n '2005, 3005p' Czebyszew.dat)" u 1:2 w l ls 1 t 'f(x) =1/(1+x^2)' , \
'' u 1:3 w l ls 2 t 'w_{15}(x)' , \
"<(sed -n '20,35p' x_m.dat)" u 1:2 w p ls 1 lc rgb '#aadc32' t 'Wezly (x_m, f(x_m))' , \